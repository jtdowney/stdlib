...
@external(lua, "../gleam_stdlib.lua", "print")
...
@external(lua, "../gleam_stdlib.lua", "print_error")
...
@external(lua, "../gleam_stdlib.lua", "console_log")
...
@external(lua, "../gleam_stdlib.lua", "console_error")
