...
@external(lua, "../gleam_stdlib.lua", "add")
...
@external(lua, "../gleam_stdlib.lua", "concat")
...
@external(lua, "../gleam_stdlib.lua", "length")
...
@external(lua, "../gleam_stdlib.lua", "split")
...
@external(lua, "../gleam_stdlib.lua", "string_replace")
pub fn replace(
  in tree: StringTree,
  each pattern: String,
